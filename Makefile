...
#
circleci/test:
	py.test --cov=src/infrastructure --cov=src/restaurant_hub --cov-report=xml:coverage-reports/coverage.xml test -n 10 -p no:warnings --dist loadscope --max-worker-restart 0

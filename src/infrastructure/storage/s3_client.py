...
class S3Client:
    ...
    def put_base64_object(self, bucket_name: str, base_64_file: str, file_key: str, content_type: str,
                          acl: str) -> str:
    ...
    def put_binary_object(self, bucket_name: str, binary_file: bytes, file_key: str, content_type: str,
                          acl: str) -> str:
        self.s3_client.put_object(
            Key=file_key,
            Body=binary_file,
